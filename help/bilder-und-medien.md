...
Before inserting an image into a page, upload it through the [Media](medien.md) tool. The tool prepares the stored image files for use in pages and, where needed, creates resized versions.
