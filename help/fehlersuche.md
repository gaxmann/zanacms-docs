...
Check whether the link uses the correct page ID. Do not mix filesystem paths, URL paths and page IDs — they are not interchangeable. See [Links](links.md) for the correct link syntax for each mode.
...
Do not edit core layout files such as `zp.css` or `zpsuper.css` directly. Use `supercustom.css`, `custom.css` or a separate design folder for your own changes. See [Design and CSS](design-und-css.md) for the safe customisation paths.
...
- [Device management](zugangsverwaltung.md)
- [Navigation](navigationeditor.md)
- [Links](links.md)
- [Design and CSS](design-und-css.md)
- [Backup and update](backup.md)
