...
This guide explains the basic file structure and setup of ZANACMS. For license terms, see [`LICENSE`](../LICENSE) and [`license-faq.md`](license-faq.md). Bundled third-party components and notes about supported external design packages are listed in [`third-party-notices.md`](third-party-notices.md).
...
| I write PHP pages | [`guide/php-mode.md`](php-mode.md) |
| I write Markdown pages | [`guide/markdown-mode.md`](markdown-mode.md) |
| I use the Rich editor | [`guide/rich-mode.md`](rich-mode.md) |
| I need links, footer syntax, CSS, page variables or public functions | [`guide/interfaces.md`](interfaces.md) |
...
Use [**PHP mode**](php-mode.md) if you want to write pages with PHP and arrays. Use [**MD mode**](markdown-mode.md) if you want lightweight Markdown files with automatic cache building. Use [**Rich mode**](rich-mode.md) if you want the normal visual editor workflow. In this file you can read about the shared parts. For public customisation and extension interfaces, see [`guide/interfaces.md`](interfaces.md).
...
The update status, update policy, warnings and breaking update boundaries are documented in [guide/update.md](update.md).
...
Read the PHP mode guide for details: [`guide/php-mode.md`](php-mode.md)
...
Read the MD mode guide for details: [`guide/markdown-mode.md`](markdown-mode.md)
...
Read the Rich mode guide for details: [`guide/rich-mode.md`](rich-mode.md)
...
* [`guide/php-mode.md`](php-mode.md) for PHP mode
* [`guide/markdown-mode.md`](markdown-mode.md) for MD mode
* [`guide/rich-mode.md`](rich-mode.md) for Rich mode
* [`guide/interfaces.md`](interfaces.md) for public customisation and extension interfaces
...
These files are required for classic WordPress themes that expect WordPress to provide jQuery. See [`third-party-notices.md`](third-party-notices.md) for license information about the bundled script files and notes about external design packages.
...
ZANACMS should be customised through documented interfaces, not by changing core files. The detailed reference is [`guide/interfaces.md`](interfaces.md). The most important points are kept here because they affect normal setup work.
...
For complete details, including all parameters of `zlink()`, `zhref()`, `ztokenhref()`, `zautop()`, `zsetlangs()`, `zautolg()`, `zquote()`, `zoutimg()` and `out_page()`, see [`guide/interfaces.md`](interfaces.md).
